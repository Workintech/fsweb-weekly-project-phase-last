export const productData = {
  ...
  properties: [
    ...
    },
    {
      ...
      label: "Kargo Şirketi",
      variants: [
        { value: "PTT", label: "Standart Kargo", priceModifier: 0 },
        { value: "yurtici", label: "Yurtiçi Kargo", priceModifier: 10 },
        { value: "aras", label: "Aras Kargo", priceModifier: 10 },
        { value: "MNG", label: "MNG Kargo", priceModifier: 15 },
      ],
    },
  ],
};
